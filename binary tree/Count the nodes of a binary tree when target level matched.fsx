...
printfn "Count the nodes of a binary tree when target level matched"
Console.WriteLine("Total nodes of a binary tree when target level matched -> {0}", List.length(getNodesMatchLevel (createBinTree depth 1) [] 1 2)) 
Console.WriteLine()
Console.WriteLine("----------------------------------------")